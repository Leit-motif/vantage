...
> Made available for reference and evaluation. **This is not open-source software** — see
> [LICENSE](LICENSE).
...
Made available for reference and evaluation. Not open source. See [LICENSE](LICENSE).
